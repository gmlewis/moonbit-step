# 36 — Bearing Seat Test Coupons

This folder contains a **working example** that generates a STEP model for: Print small “coupons” for bearing press fits across a tolerance sweep.
