# 70 — Slot And Tab Enclosure Kit

This folder contains a **working example** that generates a STEP model for: Slot-and-tab panels generated from dimensions, with kerf/clearance controls.
