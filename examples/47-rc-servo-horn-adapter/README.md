# 47 — Rc Servo Horn Adapter

This folder contains a **working example** that generates a STEP model for: An adapter that maps servo horn patterns to a custom linkage geometry.
