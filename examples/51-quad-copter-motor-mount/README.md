# 51 — Quad Copter Motor Mount

This folder contains a **working example** that generates a STEP model for: A motor mount driven by bolt circle dimensions and arm thickness rules.
