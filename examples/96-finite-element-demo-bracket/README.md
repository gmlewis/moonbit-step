# 96 — Finite Element Demo Bracket

This folder contains a **working example** that generates a STEP model for: A bracket with parameter sweeps intended for later CAE-style comparisons.
