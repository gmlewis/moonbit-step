# 94 — Airfoil Wing Section

This folder contains a **working example** that generates a STEP model for: Generate an airfoil cross-section and a printable wing segment concept model.
