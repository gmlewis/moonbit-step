# 53 — Gimbal Camera Cage

This folder contains a **working example** that generates a STEP model for: A cage with computed clearances and flexible mounting points.
