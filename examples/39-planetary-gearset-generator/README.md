# 39 — Planetary Gearset Generator

This folder contains a **working example** that generates a STEP model for: Generate sun/planet/ring proportions and clearances from a small input set.
