# 67 — Topographic Map Relief

This folder contains a **working example** that generates a STEP model for: A relief model generated from contour lines or a height function (concept first).
