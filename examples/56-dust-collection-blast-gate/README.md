# 56 — Dust Collection Blast Gate

This folder contains a **working example** that generates a STEP model for: A blast gate assembly with sliding geometry and configurable stop positions.
