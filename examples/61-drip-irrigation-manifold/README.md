# 61 — Drip Irrigation Manifold

This folder contains a **working example** that generates a STEP model for: A multi-outlet manifold where spacing and outlet count are computed.
