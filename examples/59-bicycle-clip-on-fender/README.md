# 59 — Bicycle Clip On Fender

This folder contains a **working example** that generates a STEP model for: A fender concept model that’s easy to resize by wheel radius and clearance.
