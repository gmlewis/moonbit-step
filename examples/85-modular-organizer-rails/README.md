# 85 — Modular Organizer Rails

This folder contains a **working example** that generates a STEP model for: Rails and clips that snap into a system, showing tolerance-aware mating parts.
