# 84 — Pegboard Hook Set

This folder contains a **working example** that generates a STEP model for: A family of pegboard hooks generated from “tool silhouettes” and rules.
